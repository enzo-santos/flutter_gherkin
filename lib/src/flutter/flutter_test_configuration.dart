...
class FlutterTestConfiguration extends TestConfiguration {
  ...
  static FlutterTestConfiguration DEFAULT(
    ...
    Iterable<Hook>? hooks,
    Future<World> Function(TestConfiguration)? createWorld,
  ...
  FlutterTestConfiguration({
    super.features,
    super.featureDefaultLanguage,
    super.order,
    super.defaultTimeout,
    super.featureFileMatcher,
    super.featureFileReader,
    super.stopAfterTestFailed,
    super.tagExpression,
